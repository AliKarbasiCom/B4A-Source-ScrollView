...
mostCurrent._activity.LoadLayout("main",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="ScrollView1.Panel.LoadLayout(\"sv\")";
mostCurrent._scrollview1.getPanel().LoadLayout("sv",mostCurrent.activityBA);
 //BA.debugLineNum = 29;BA.debugLine="HorizontalScrollView1.Panel.LoadLayout(\"svh\")";
mostCurrent._horizontalscrollview1.getPanel().LoadLayout("svh",mostCurrent.activityBA);
